...
// bootstrap carousel just below the header navbar
const Banner = () => {
  return (
    <div
      ...
      <div className="carousel-inner">
        ...
        <div className="carousel-item" data-bs-interval="2000">
          ...
          <div className="carousel-caption d-none d-md-block">
            <h3>Commonwealth Hospital and Medical Center</h3>
            <p>Commonwealth funding for this hospital.</p>
          </div>
        </div>
        <div className="carousel-item" data-bs-interval="3000">
          ...
          <div className="carousel-caption d-none d-md-block">
            ...
            <p>22 Flore building hospital first time in this city.</p>
          </div>
        </div>
        <div className="carousel-item">
          <img src={banner04} className="d-block w-100" alt="..." />
          <div className="carousel-caption d-none d-md-block"></div>
        </div>
      </div>
      <button
